...
public class AppUserService implements UserDetailsService {
    ...
    public String signUpUser(AppUser appUser) {
        ...
        if (userExists) {
            ...
            Optional<ConfirmationToken> confirmationToken = confirmationTokenService.checkToken(user.get().getId());
            ...
            appUserRepository.deleteAppUserById(user.get().getId());
    ...
    public boolean emailCheck(String email){
        ...
        boolean flag = false;
        if(user.isPresent()){
            flag = !user.get().isEnabled();
        }
        return matcher.matches() && (appUserRepository.findByEmail(email).isEmpty() || flag);
    }
